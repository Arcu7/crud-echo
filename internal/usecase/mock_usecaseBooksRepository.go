...
func (_m *MockusecaseBooksRepository) GetAll(users *models.BooksList) error {
	ret := _m.Called(users)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.BooksList) error); ok {
		r0 = rf(users)
	} else {
		r0 = ret.Error(0)
	}
...
//   - users *models.BooksList
func (_e *MockusecaseBooksRepository_Expecter) GetAll(users interface{}) *MockusecaseBooksRepository_GetAll_Call {
	return &MockusecaseBooksRepository_GetAll_Call{Call: _e.mock.On("GetAll", users)}
}

func (_c *MockusecaseBooksRepository_GetAll_Call) Run(run func(users *models.BooksList)) *MockusecaseBooksRepository_GetAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*models.BooksList))
	})
	return _c
}
...
func (_c *MockusecaseBooksRepository_GetAll_Call) RunAndReturn(run func(*models.BooksList) error) *MockusecaseBooksRepository_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
